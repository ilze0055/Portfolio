    ...
    <div class="contact-form">
      ...
      <form @submit.prevent="onSubmit">
       ...
       <div class="contact-header">
          <p class="maintitle">Contact me</p> 
        </div>


        <div class="contact-header">
          <p class="fadeInUp animated">+45 91876751 <b> +371 29350159 </b> <b> if040691@gmail.com </b></p> 
        </div>
